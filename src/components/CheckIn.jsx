...
const CheckIn = ({ onBack, onFinalizar }) => {
  ...
  // Termo: Data Retrieval Query - Buscando histórico do cliente pela placa
  const buscarHistoricoCliente = (placaDigitada) => {
    ...
    onValue(financeiroRef, (snapshot) => {
      ...
      if (data) {
        ...
        // Filtra o registro mais recente deste cliente para preenchimento automático
        ...
        if (clienteRecente) {
          ...
          console.log("Anúbis Tech: Dados recuperados para " + placaLimpa);
        }
      }
      setIsNovo(true); // Avança para a próxima tela após a busca
    }, { onlyOnce: true });
  };
    ...
    <div className="max-w-2xl mx-auto animate-in fade-in pb-10">
      <div className="bg-[#161b2c] p-8 rounded-3xl border border-slate-800 shadow-2xl relative">
        ...
        <header className="text-center mb-8 pt-4">
          ...
          <h2 className="text-2xl font-black italic uppercase tracking-widest text-white font-black">Check-in ControlFlow</h2>
        </header>
